...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxActivityLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v1122</b> with <b>androidx.activity:activity</b> coordinates and
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getV1122() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.activity.v1122");
        }
    ...
    public static class TensorflowLibraryAccessors extends SubDependencyFactory {
        ...
        private final TensorflowTensorflowLibraryAccessors laccForTensorflowTensorflowLibraryAccessors = new TensorflowTensorflowLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>tensorflow.tensorflow</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public TensorflowTensorflowLibraryAccessors getTensorflow() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForTensorflowTensorflowLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class TensorflowTensorflowLibraryAccessors extends SubDependencyFactory {
        private final TensorflowTensorflowLiteLibraryAccessors laccForTensorflowTensorflowLiteLibraryAccessors = new TensorflowTensorflowLiteLibraryAccessors(owner);

        public TensorflowTensorflowLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>tensorflow.tensorflow.lite</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public TensorflowTensorflowLiteLibraryAccessors getLite() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForTensorflowTensorflowLiteLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class TensorflowTensorflowLiteLibraryAccessors extends SubDependencyFactory {
        private final TensorflowTensorflowLiteTaskLibraryAccessors laccForTensorflowTensorflowLiteTaskLibraryAccessors = new TensorflowTensorflowLiteTaskLibraryAccessors(owner);

        public TensorflowTensorflowLiteLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getMetadata() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("tensorflow.tensorflow.lite.metadata");
        }

        /**
         * Group of libraries at <b>tensorflow.tensorflow.lite.task</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public TensorflowTensorflowLiteTaskLibraryAccessors getTask() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForTensorflowTensorflowLiteTaskLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class TensorflowTensorflowLiteTaskLibraryAccessors extends SubDependencyFactory {

        public TensorflowTensorflowLiteTaskLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getVision() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("tensorflow.tensorflow.lite.task.vision");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>activityVersion</b> with value <b>1.12.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>roomCompiler</b> with value <b>2.8.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>roomKtx</b> with value <b>2.8.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>tensorflowLiteMetadata</b> with value <b>0.4.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>tensorflowLiteTaskVision</b> with value <b>0.4.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
